...
class CustomerConfigManager:
    ...
    def generate_customer_config(
        ...
        **kwargs
        ...
        profile = CustomerProfile(
            ...
            implementation_timeline=package_config['package_info']['implementation_time'],
        ...
        config = CustomerConfig(
            ...
            business_objectives=package_config.get('default_configuration', {}).get('business_objectives', {}),
            technical_environment=package_config.get('default_configuration', {}).get('technical_environment', {}),
            operational_constraints=package_config.get('default_configuration', {}).get('operational_constraints', {}),
            agent_configuration={
                'selected_package': package_type,
                'agents': package_config.get('agents', {}),
                'performance_targets': package_config.get('default_configuration', {}).get('agent_configuration', {}).get('performance_targets', {})
            },
            integrations={
                'linear': {'enabled': True},
                'github': {'enabled': True},
            ...
            monitoring=package_config.get('default_configuration', {}).get('monitoring', {}),
            security={
    ...
    def save_customer_config(self, customer_config: CustomerConfig) -> Path:
        ...
        with open(metadata_file, 'w') as f:
            json.dump({
                ...
                'package_type': customer_config.agent_configuration['selected_package'],
    ...
    def load_customer_config(self, customer_id: str) -> Optional[CustomerConfig]:
        ...
        config_file = self.customers_dir / customer_id / "config" / "customer-config.yaml"
    ...
    def validate_customer_config(self, config: Union[CustomerConfig, Dict[str, Any]]) -> List[str]:
        ...
        package_type = self._get_nested_field(config_dict, 'agent_configuration.selected_package')
    ...
    def get_customer_status(self, customer_id: str) -> Dict[str, Any]:
        ...
        status = {
            'customer_id': customer_id,
            'config_exists': (customer_dir / "config" / "customer-config.yaml").exists(),
