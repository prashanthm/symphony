...
from symphony_integrations.linear.template_engine import TemplateEngine, ConfigurationWizard
from symphony_integrations.linear.template_models import (
    WorkspaceTemplate, OrganizationConfig, TeamTemplate,
...
def sample_inheritance_template():
    ...
    return {
        "inherits_from": ["base"],
        "workspace": {
            "name": "${customer_name} Extended Workspace"  # Override name
        },
        "teams": [
            {
...
def sample_customer_config():
    ...
    return {
        ...
        "workspace": {
            "description": "Custom description for Test Corp"
        },
        "teams": [
            {
                "name": "Custom Team",
...
class TestTemplateLoading:
    ...
    def test_load_simple_template(self, template_engine, temp_templates_dir, sample_template_yaml):
    ...
    def test_load_template_with_variables(self, template_engine, temp_templates_dir, sample_template_yaml):
...
class TestVariableSubstitution:
    ...
    def test_invalid_expression_returns_original(self, template_engine):
        ...
        result = template_engine._evaluate_expression("invalid.expression.chain", variables)
...
class TestTemplateInheritance:
    ...
    def test_single_template_inheritance(self, template_engine, temp_templates_dir, 
                                       sample_base_template, sample_inheritance_template):
        ...
        team_names = [team.name for team in template.teams if hasattr(template, 'teams') and template.teams]
    ...
    def test_inheritance_chain(self, template_engine, temp_templates_dir):
        ...
        grandparent = {"workspace": {"name": "Grandparent"}, "base_value": "from_grandparent"}
    ...
    def test_inheritance_overrides(self, template_engine, temp_templates_dir):
        ...
        assert processed["workspace"]["description"] == "Parent Description"  # Inherited
...
class TestCustomerConfigProcessing:
    ...
    def test_process_customer_config(self, template_engine, temp_templates_dir, sample_customer_config):
...
class TestTemplateSaving:
    ...
    def test_save_template_cleans_none_values(self, template_engine, temp_templates_dir):
