...
from symphony_integrations.linear.template_models import (
    ...
    WorkspacePreview, BrandingConfig, VariableConfig
)
...
class TestIndustryType:
    ...
    def test_industry_types_available(self):
        ...
        expected_industries = [
            ...
            "consulting", "retail", "education", "government"
        ]
...
class TestFieldType:
    ...
    def test_field_types_available(self):
        ...
        expected_types = ["text", "number", "select", "multi_select", "date", "boolean", "url"]
...
class TestTeamTemplate:
    ...
    def test_team_with_sub_teams(self):
        ...
        sub_teams = [
            TeamTemplate("Frontend", "FE"),
            TeamTemplate("Backend", "BE")
        ]
...
class TestInitiative:
    ...
    def test_initiative_with_sub_initiatives(self):
        ...
        initiative = Initiative(
            name="Digital Transformation",
            level=1,
            sub_initiatives=sub_initiatives
        )
    ...
    def test_initiative_hierarchy_levels(self):
        ...
        level_2_init = Initiative("Process Automation", 2, sub_initiatives=[level_3_init])
        level_1_init = Initiative("Digital Transformation", 1, sub_initiatives=[level_2_init])
...
class TestWorkspaceTemplate:
    ...
    def test_complete_workspace_template(self):
        ...
        initiatives = [
            Initiative("Product Excellence", 1)
        ]
        
        projects = [
            ProjectTemplate("mvp_project", "MVP Development")
        ]
...
class TestModelIntegration:
    ...
    def test_team_with_custom_fields_and_workflows(self):
        ...
        custom_fields = [
            ...
            CustomField("Component", FieldType.MULTI_SELECT, options=["Frontend", "Backend", "Database"])
        ]
        ...
        story_points_field = next(f for f in team.custom_fields if f.name == "Story Points")
